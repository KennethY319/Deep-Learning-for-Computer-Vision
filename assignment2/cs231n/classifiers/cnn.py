...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dback, grads['W3'], grads['b3'] = affine_backward(dscore, cache3)
        drelu, grads['W2'], grads['b2'] = affine_relu_backward(dback, cache2)
        dx, grads['W1'], grads['b1'] = conv_relu_pool_backward(drelu, cache1)
